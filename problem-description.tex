...
When the high availability system will be described these same servers will be refered to as \textit{nodes} as this is the way most high availability software refer to their own cluster machines.
